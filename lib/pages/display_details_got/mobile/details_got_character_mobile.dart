...
import 'package:projet_flutter/pages/display_rating/mobile/display_rating_mobile.dart';
import 'package:simple_star_rating/simple_star_rating.dart';

class DetailsGotCharacterMobile extends StatefulWidget {
  const DetailsGotCharacterMobile({
    Key? key,
...
class DetailsGotCharacterState extends State<DetailsGotCharacterMobile> {
  List _opinions = [];
  late double height;
  late double width;
              ...
              child: FloatingActionButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          DisplayRatingMobile(name: widget.character.fullName)));
                },
  ...
  Widget _getOpinion() {
    if (_opinions.isNotEmpty) {
      double test = (_opinions[0]["rating"]);
