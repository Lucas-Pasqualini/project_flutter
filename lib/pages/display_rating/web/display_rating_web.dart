...
class DisplayRatingWeb extends StatefulWidget {
  const DisplayRatingWeb({Key? key, required this.name, }) : super(key: key);
...
class _RatingState extends State<DisplayRatingWeb> {
